...
/**
 * The recommender for the GraphChi ALS Algorithm. Currently it doesn't use user history.
 * Other than this, it behaves identically to ScoreBasedItemRecommender.
 *
 * @author Daniel Gratzer < danny.gratzer@gmail.com >
 */
public class AlsRecommender extends ScoreBasedItemRecommender {

    @Inject
    public AlsRecommender(DataAccessObject dao, AlsRatingPredictor pred){
        super (dao, pred);
    }
