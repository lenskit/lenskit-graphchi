...
public interface MatrixSource extends Cursor<MatrixEntry>{
    ...
    /**
     * @return The number of entries in the matrix. Note that this isn't meant to change as the matrix is
     * processed. It should return the total number of entries in the matrix.
     */
    public int getMatrixEntryCount();

    /**
     * @return Whether or not the matrix is sorted.
     */
